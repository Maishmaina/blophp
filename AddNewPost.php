   ...
   if(isset($_POST["Submit"])){
     ...
     $Target="Upload/".basename($_FILES["Image"]["name"]);
      if(empty($Title)){
        ...
        global $Select;
        $Query="INSERT INTO admin_panel(datetimes,title,category,author,image,post)
        VALUES('$today','$Title','$Category','$Admin','$Image','$Post')";
...
<body>
  ...
  <div class=" col-sm-12 my-3 py-2 mr-1 text-light sidemenu" id="sidemenu"><i class="fa fa-tachometer-alt fa-1x"></i>&nbsp;<a class="text-white" href="Simple.php">Dashboard </a></div></div>
 <div class="row"><div class="col-sm-12 sidemenu my-3 py-2 mr-1 text-light bg-primary"  id="sidemenu"><i class="fa fa-ad fa-1x"></i>&nbsp;<a class="text-white" href="AddNewPost.php">Add New Post</a></div></div>
  ...
  <div class="row"><div class="col-sm-12 sidemenu my-3 py-2 mr-1 text-light" id="sidemenu" ><i class="fa fa-comment-alt"></i>&nbsp;<a class="text-white" href="Comments.php">Comment</a></div></div>
  <div class="row"><div class="col-sm-12 sidemenu my-3 py-2 mr-1 text-light" id="sidemenu" ><i class="fab fa-blogger"></i>&nbsp;<a class="text-white" href="Bolg.php">Live Bolg</a></div></div>
        ...
        <input class="form-control form-control-lg" type="text" name="Title" id="title" placeholder="Title">
            ...
            <div class="form-group">
              ...
              <select class="form-control form-control-lg" name="Category" id="categoryselect">
                ...
                <?php
             global $Select;//get category from the data base... to select them.
            ...
            <button  class="btn btn-outline-success btn-block form-control" type="Submit" name="Submit" value="Add New Category"><i class="far fa-hand-point-right mr-2"> </i> Add New Category</button>
