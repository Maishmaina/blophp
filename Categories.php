   ...
   if(isset($_POST["Submit"])){
     ...
     $Admin=$_SESSION["Username"];
      if(empty($Category)){
        ...
        $_SESSION["ErrorMessage"] = "Too Long For Category";
        Redirect_to("Categories.php");
      }else{
        global $Select;
        $Query="INSERT INTO category(datetimes,name,creatorname)
        VALUES('$today','$Category','$Admin')";
...
<body>
  ...
  <div class=" col-sm-12 my-3 py-2 mr-1 sidemenu text-light" id="sidemenu"><i class="fa fa-tachometer-alt fa-1x"></i>&nbsp;<a class="text-white" href="Simple.php">Dashboard </a></div></div>
 <div class="row"><div class="col-sm-12 sidemenu my-3 py-2 mr-1 text-light"  id="sidemenu"><i class="fa fa-ad fa-1x"></i>&nbsp;<a class="text-white" href="AddNewPost.php">Add New Post</a></div></div>
  <div class="row"><div class="col-sm-12 sidemenu my-3 py-2 mr-1 text-light bg-primary" id="sidemenu" ><i class="fa fa-layer-group"></i>&nbsp;<a class="text-white" href="Categories.php">Categories</a></div></div>
