     ...
     $Target="Upload/".basename($_FILES["Image"]["name"]);
      if(empty($Title)){
        ...
        if($tryOut){
          ...
          $_SESSION["ErrorMessage"] = " Failed to Deleted the Post";
          Redirect_to("Simple.php");
        }
      }
   }
        ...
        <input value="<?php echo $TitleToBeUpdated; ?> " class="form-control form-control-lg" type="text" name="Title" id="title" placeholder="Title">
            ...
            <?php echo $CategoryToBeUpdated; ?> <br>
              ...
              <select class="form-control form-control-lg" name="Category" id="categoryselect">
                ...
                <?php
             global $Select;
             $ViewQuery="SELECT * FROM category ORDER BY datetimes desc";
            ...
            <button  class="btn btn-outline-danger btn-block form-control" type="Submit" name="Submit"><i class="far fa-hand-point-right mr-2"> </i> Delete Post</button>
